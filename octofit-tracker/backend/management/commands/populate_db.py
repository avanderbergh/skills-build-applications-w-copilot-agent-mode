...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f'Total teams: {team_count}'))
        activity_count = Activity.objects.count()
        self.stdout.write(self.style.SUCCESS(f'Total activities: {activity_count}'))
        leaderboard_count = Leaderboard.objects.count()
        self.stdout.write(self.style.SUCCESS(f'Total leaderboard entries: {leaderboard_count}'))
        workout_count = Workout.objects.count()
        self.stdout.write(self.style.SUCCESS(f'Total workouts: {workout_count}'))